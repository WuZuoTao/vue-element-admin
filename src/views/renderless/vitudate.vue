<template>
  <form ref="valuedate" class="container">
    ...
    <svitu-date ref="valuedate" class="stide">
      <el-button type="primary" class="btn-left" @click="SubmitForm()">立即创建</el-button>
...
<script>
import SvituDate from './index.vue'
